...
* 🔥 **FAIL** <p>OS/2.usWinAscent value should be equal or greater than 1191, but got 1069 instead</p>
 [code: ascent]



* 🔥 **FAIL** <p>OS/2.usWinDescent value should be equal or greater than 419, but got 293 instead</p>
 [code: descent]
...
* 🔥 **FAIL** <p>.notdef glyphs were found when attempting to render Noto Naskh Arabic UI</p>
