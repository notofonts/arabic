...
<h2>Check results</h2><details><summary><b>[15] NotoKufiArabic[wght].ttf</b></summary><div><details><summary>💔 <b>ERROR:</b> Check Google Fonts glyph coverage. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/glyph_coverage">com.google.fonts/check/glyph_coverage</a>)</summary><div>
...
* 🔥 **FAIL** OS/2.usWinDescent value should be equal or greater than 650, but got 615 instead [code: descent]
...
* 🔥 **FAIL** The following glyphs could not be attached to the dotted circle glyph:
	...
	- uni08E1 [code: unattached-dotted-circle-marks]
 ...
 * U+200F RIGHT-TO-LEFT MARK: try adding one of: phags-pa, thaana, hebrew, nko, syriac
 * U+202F NARROW NO-BREAK SPACE: try adding one of: yi, mongolian
 * U+221A SQUARE ROOT: try adding math
 * U+25CC DOTTED CIRCLE: try adding one of: chakma, miao, caucasian-albanian, telugu, lao, tirhuta, manichaean, gunjala-gondi, batak, tibetan, hanifi-rohingya, syriac, masaram-gondi, gurmukhi, syloti-nagri, hanunoo, javanese, canadian-aboriginal, kayah-li, warang-citi, coptic, elbasan, khojki, nko, siddham, cham, newa, oriya, psalter-pahlavi, khmer, myanmar, math, hebrew, brahmi, yi, tagbanwa, zanabazar-square, balinese, marchen, tifinagh, duployan, kannada, sogdian, saurashtra, bhaiksuki, wancho, ahom, tai-tham, sinhala, symbols, music, adlam, devanagari, buhid, meetei-mayek, kharoshthi, gujarati, thaana, mandaic, tamil, tai-le, pahawh-hmong, osage, sharada, sundanese, rejang, bengali, old-permic, khudawadi, new-tai-lue, soyombo, limbu, grantha, buginese, takri, modi, tagalog, malayalam, mahajani, armenian, tai-viet, mende-kikakui, dogra, phags-pa, thai, kaithi, bassa-vah, lepcha, mongolian
...
Your font does *not* cover the following languages that require the soft-dotted feature: Mundani (Latn, 34,000 speakers), Ejagham (Latn, 120,000 speakers), Koonzime (Latn, 40,000 speakers), Bafut (Latn, 158,146 speakers), Nzakara (Latn, 50,000 speakers), Fur (Latn, 1,230,163 speakers), Kom (Latn, 360,685 speakers), Lugbara (Latn, 2,200,000 speakers), Ekpeye (Latn, 226,000 speakers), Ngbaka (Latn, 1,020,000 speakers), Mango (Latn, 77,000 speakers), Dii (Latn, 71,000 speakers), Belarusian (Cyrl, 10,064,517 speakers), Aghem (Latn, 38,843 speakers), Nateni (Latn, 100,000 speakers), Bete-Bendi (Latn, 100,000 speakers), Navajo (Latn, 166,319 speakers), Zapotec (Latn, 490,000 speakers), Dan (Latn, 1,099,244 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Southern Kisi (Latn, 360,000 speakers), Basaa (Latn, 332,940 speakers), Yala (Latn, 200,000 speakers), Ebira (Latn, 2,200,000 speakers), Avokaya (Latn, 100,000 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Sar (Latn, 500,000 speakers), South Central Banda (Latn, 244,000 speakers), Mfumte (Latn, 79,000 speakers), Ma’di (Latn, 584,000 speakers), Cicipu (Latn, 44,000 speakers), Igbo (Latn, 27,823,640 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Gulay (Latn, 250,478 speakers), Makaa (Latn, 221,000 speakers). [code: soft-dotted]
