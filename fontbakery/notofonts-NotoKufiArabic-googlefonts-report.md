 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: syriac, malayalam, tai-le, old-permic, coptic, canadian-aboriginal, math, tifinagh
 ...
 * U+200F RIGHT-TO-LEFT MARK: try adding one of: thaana, syriac, nko, phags-pa, hebrew
 * U+202F NARROW NO-BREAK SPACE: try adding one of: mongolian, yi
 * U+221A SQUARE ROOT: try adding math
 * U+25CC DOTTED CIRCLE: try adding one of: sogdian, sinhala, kharoshthi, tai-le, batak, malayalam, hanifi-rohingya, balinese, syloti-nagri, devanagari, lao, mahajani, tamil, soyombo, warang-citi, siddham, tibetan, elbasan, javanese, lepcha, bassa-vah, kayah-li, manichaean, tai-tham, brahmi, music, bhaiksuki, mende-kikakui, adlam, telugu, hebrew, armenian, new-tai-lue, saurashtra, nko, kaithi, thai, kannada, khudawadi, khmer, masaram-gondi, buhid, hanunoo, thaana, takri, caucasian-albanian, rejang, math, cham, oriya, khojki, mandaic, tirhuta, limbu, gurmukhi, meetei-mayek, bengali, dogra, newa, yi, tagbanwa, pahawh-hmong, ahom, duployan, gujarati, osage, old-permic, tagalog, mongolian, wancho, sundanese, phags-pa, chakma, buginese, psalter-pahlavi, tifinagh, gunjala-gondi, myanmar, grantha, symbols, marchen, sharada, coptic, modi, syriac, miao, zanabazar-square, canadian-aboriginal, tai-viet
...
Your font does *not* cover the following languages that require the soft-dotted feature: Bafut (Latn, 158,146 speakers), Ejagham (Latn, 120,000 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Ekpeye (Latn, 226,000 speakers), Avokaya (Latn, 100,000 speakers), Koonzime (Latn, 40,000 speakers), Mundani (Latn, 34,000 speakers), Nateni (Latn, 100,000 speakers), Nzakara (Latn, 50,000 speakers), Lugbara (Latn, 2,200,000 speakers), Yala (Latn, 200,000 speakers), Dan (Latn, 1,099,244 speakers), Southern Kisi (Latn, 360,000 speakers), Fur (Latn, 1,230,163 speakers), Zapotec (Latn, 490,000 speakers), Dii (Latn, 71,000 speakers), South Central Banda (Latn, 244,000 speakers), Ngbaka (Latn, 1,020,000 speakers), Mango (Latn, 77,000 speakers), Igbo (Latn, 27,823,640 speakers), Basaa (Latn, 332,940 speakers), Aghem (Latn, 38,843 speakers), Kom (Latn, 360,685 speakers), Mfumte (Latn, 79,000 speakers), Cicipu (Latn, 44,000 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Gulay (Latn, 250,478 speakers), Belarusian (Cyrl, 10,064,517 speakers), Makaa (Latn, 221,000 speakers), Ma’di (Latn, 584,000 speakers), Navajo (Latn, 166,319 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Sar (Latn, 500,000 speakers), Ebira (Latn, 2,200,000 speakers), Bete-Bendi (Latn, 100,000 speakers). [code: soft-dotted]
