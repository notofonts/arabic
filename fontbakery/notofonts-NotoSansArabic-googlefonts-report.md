...
<h2>Check results</h2><details><summary><b>[14] NotoSansArabic[wdth,wght].ttf</b></summary><div><details><summary>💔 <b>ERROR:</b> Check Google Fonts glyph coverage. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/glyph_coverage">com.google.fonts/check/glyph_coverage</a>)</summary><div>
...
* 🔥 **FAIL** Version number 2.012 is equal to version on google/fonts **GitHub repo**.
...
* 🔥 **FAIL** The following glyphs could not be attached to the dotted circle glyph:
	...
	- uni08DF [code: unattached-dotted-circle-marks]
 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: tai-le, math, malayalam, old-permic, canadian-aboriginal, coptic, tifinagh, syriac
 ...
 * U+200F RIGHT-TO-LEFT MARK: try adding one of: phags-pa, hebrew, thaana, nko, syriac
 * U+202F NARROW NO-BREAK SPACE: try adding one of: mongolian, yi
 * U+221A SQUARE ROOT: try adding math
 * U+25CC DOTTED CIRCLE: try adding one of: saurashtra, batak, rejang, khmer, khojki, kannada, masaram-gondi, warang-citi, gunjala-gondi, meetei-mayek, hanunoo, old-permic, kayah-li, myanmar, duployan, mongolian, gurmukhi, devanagari, tifinagh, chakma, tai-le, tirhuta, ahom, symbols, armenian, tagbanwa, tamil, osage, yi, manichaean, brahmi, mende-kikakui, malayalam, sogdian, wancho, limbu, bhaiksuki, oriya, siddham, bassa-vah, nko, modi, new-tai-lue, syloti-nagri, khudawadi, miao, mandaic, lao, balinese, thaana, thai, tibetan, bengali, syriac, lepcha, kharoshthi, music, telugu, soyombo, psalter-pahlavi, mahajani, buginese, buhid, hanifi-rohingya, takri, caucasian-albanian, tai-viet, javanese, adlam, tagalog, kaithi, canadian-aboriginal, grantha, coptic, math, phags-pa, elbasan, gujarati, sharada, hebrew, marchen, pahawh-hmong, cham, sundanese, dogra, tai-tham, sinhala, newa, zanabazar-square
...
Your font does *not* cover the following languages that require the soft-dotted feature: Yala (Latn, 200,000 speakers), Kom (Latn, 360,685 speakers), Aghem (Latn, 38,843 speakers), Sar (Latn, 500,000 speakers), Nateni (Latn, 100,000 speakers), Mango (Latn, 77,000 speakers), Makaa (Latn, 221,000 speakers), Ukrainian (Cyrl, 29,273,587 speakers), South Central Banda (Latn, 244,000 speakers), Ejagham (Latn, 120,000 speakers), Dan (Latn, 1,099,244 speakers), Ma’di (Latn, 584,000 speakers), Nzakara (Latn, 50,000 speakers), Avokaya (Latn, 100,000 speakers), Igbo (Latn, 27,823,640 speakers), Ekpeye (Latn, 226,000 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Belarusian (Cyrl, 10,064,517 speakers), Southern Kisi (Latn, 360,000 speakers), Zapotec (Latn, 490,000 speakers), Koonzime (Latn, 40,000 speakers), Bete-Bendi (Latn, 100,000 speakers), Bafut (Latn, 158,146 speakers), Ebira (Latn, 2,200,000 speakers), Cicipu (Latn, 44,000 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Fur (Latn, 1,230,163 speakers), Basaa (Latn, 332,940 speakers), Navajo (Latn, 166,319 speakers), Gulay (Latn, 250,478 speakers), Lugbara (Latn, 2,200,000 speakers), Mfumte (Latn, 79,000 speakers), Ngbaka (Latn, 1,020,000 speakers), Dii (Latn, 71,000 speakers), Mundani (Latn, 34,000 speakers). [code: soft-dotted]
