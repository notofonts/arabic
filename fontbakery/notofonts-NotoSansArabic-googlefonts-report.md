 ...
 * U+0307 COMBINING DOT ABOVE: try adding one of: canadian-aboriginal, old-permic, syriac, tai-le, tifinagh, math, malayalam, coptic
 ...
 * U+200F RIGHT-TO-LEFT MARK: try adding one of: nko, syriac, phags-pa, thaana, hebrew
 * U+202F NARROW NO-BREAK SPACE: try adding one of: mongolian, yi
 * U+221A SQUARE ROOT: try adding math
 * U+25CC DOTTED CIRCLE: try adding one of: masaram-gondi, batak, devanagari, thaana, bengali, old-permic, sogdian, elbasan, limbu, dogra, nko, sinhala, yi, oriya, mende-kikakui, mahajani, zanabazar-square, khojki, wancho, sundanese, armenian, psalter-pahlavi, kaithi, hebrew, gurmukhi, osage, tai-viet, chakma, pahawh-hmong, new-tai-lue, tagbanwa, sharada, buginese, mandaic, marchen, tirhuta, tai-tham, thai, lao, balinese, adlam, cham, buhid, bassa-vah, takri, kharoshthi, symbols, gujarati, syloti-nagri, music, math, mongolian, manichaean, rejang, gunjala-gondi, tifinagh, kannada, miao, brahmi, hanunoo, tagalog, tamil, coptic, hanifi-rohingya, khudawadi, khmer, malayalam, javanese, canadian-aboriginal, modi, lepcha, kayah-li, syriac, duployan, ahom, saurashtra, telugu, tibetan, warang-citi, soyombo, tai-le, newa, meetei-mayek, caucasian-albanian, grantha, phags-pa, siddham, myanmar, bhaiksuki
...
Your font does *not* cover the following languages that require the soft-dotted feature: Sar (Latn, 500,000 speakers), South Central Banda (Latn, 244,000 speakers), Lugbara (Latn, 2,200,000 speakers), Ejagham (Latn, 120,000 speakers), Kom (Latn, 360,685 speakers), Zapotec (Latn, 490,000 speakers), Aghem (Latn, 38,843 speakers), Mfumte (Latn, 79,000 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Ebira (Latn, 2,200,000 speakers), Navajo (Latn, 166,319 speakers), Nzakara (Latn, 50,000 speakers), Bafut (Latn, 158,146 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Basaa (Latn, 332,940 speakers), Dan (Latn, 1,099,244 speakers), Belarusian (Cyrl, 10,064,517 speakers), Makaa (Latn, 221,000 speakers), Southern Kisi (Latn, 360,000 speakers), Dii (Latn, 71,000 speakers), Mango (Latn, 77,000 speakers), Ekpeye (Latn, 226,000 speakers), Mundani (Latn, 34,000 speakers), Koonzime (Latn, 40,000 speakers), Fur (Latn, 1,230,163 speakers), Ngbaka (Latn, 1,020,000 speakers), Gulay (Latn, 250,478 speakers), Bete-Bendi (Latn, 100,000 speakers), Nateni (Latn, 100,000 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Igbo (Latn, 27,823,640 speakers), Yala (Latn, 200,000 speakers), Avokaya (Latn, 100,000 speakers), Ma’di (Latn, 584,000 speakers), Cicipu (Latn, 44,000 speakers). [code: soft-dotted]
